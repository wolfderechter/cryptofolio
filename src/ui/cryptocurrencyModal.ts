...
export function openCryptocurrencyModal(assetId: string) {
  ...
  const errorDiv = document.getElementById("cryptocurrencyModalError") as HTMLDivElement;
  ...
  const handleSubmit = (e: Event) => {
    ...
    const coingeckoId = (document.getElementById("cryptocurrencyId") as HTMLInputElement).value.trim();
    const symbol = (document.getElementById("cryptocurrencySymbol") as HTMLInputElement).value.trim();
    const name = (document.getElementById("cryptocurrencyName") as HTMLInputElement).value.trim();
